...
public class Tiger {
	public static void main(String[] args) {
		...
		case X86:
			// similar
			break;
		// Lab3 exercise 8 by king
		case EXE:
			codegen.C.TranslateVisitor transC0 = new codegen.C.TranslateVisitor();
			theAst.accept(transC0);
			codegen.C.Ast.Program.T cAst0 = transC0.program;
			codegen.C.PrettyPrintVisitor ppc0 = new codegen.C.PrettyPrintVisitor();
			cAst0.accept(ppc0);
